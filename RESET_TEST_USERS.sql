...
('testuser1', '$2a$12$1eemldr5sR9NP8f/mt.GludB5WX3HfPnCYjbXMwXsSXGUu5aXUZOi', 'lx000001', 'user', 'active', NOW(), NOW(), NULL),
('testuser2', '$2a$12$1eemldr5sR9NP8f/mt.GludB5WX3HfPnCYjbXMwXsSXGUu5aXUZOi', 'lx000002', 'user', 'active', NOW(), NOW(), NULL),
('testuser3', '$2a$12$1eemldr5sR9NP8f/mt.GludB5WX3HfPnCYjbXMwXsSXGUu5aXUZOi', 'lx000003', 'user', 'active', NOW(), NOW(), NULL),
('testuser4', '$2a$12$1eemldr5sR9NP8f/mt.GludB5WX3HfPnCYjbXMwXsSXGUu5aXUZOi', 'lx000004', 'user', 'active', NOW(), NOW(), NULL)
ON DUPLICATE KEY UPDATE 
    password = '$2a$12$1eemldr5sR9NP8f/mt.GludB5WX3HfPnCYjbXMwXsSXGUu5aXUZOi',
    status = 'active',
    deleted_at = NULL,
    updated_at = NOW();
...
-- 创建管理员账号
INSERT INTO users (username, password, lanxin_id, role, status, created_at, updated_at, deleted_at) VALUES
('admin', '$2a$12$1eemldr5sR9NP8f/mt.GludB5WX3HfPnCYjbXMwXsSXGUu5aXUZOi', 'lx999999', 'admin', 'active', NOW(), NOW(), NULL)
ON DUPLICATE KEY UPDATE 
    password = '$2a$12$1eemldr5sR9NP8f/mt.GludB5WX3HfPnCYjbXMwXsSXGUu5aXUZOi',
    status = 'active',
    deleted_at = NULL,
